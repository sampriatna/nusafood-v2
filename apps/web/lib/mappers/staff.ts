...
export function mapStaffToApi(staff: StaffWithRelations): Staff {
  return {
    ...
    hris_staff_id: staff.hrisStaffId,
    hris_employee_code: staff.hrisEmployeeCode,
    hris_outlet_code: staff.hrisOutletCode,
    hris_division_code: staff.hrisDivisionCode,
    hris_division_name: staff.hrisDivisionName,
    hris_position_code: staff.hrisPositionCode,
