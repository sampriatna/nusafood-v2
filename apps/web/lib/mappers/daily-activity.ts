...
export function mapDailySubmission(
  ...
  return {
    ...
    leader_validation: sub.leaderValidation ?? null,
    leader_validation_note: sub.leaderValidationNote ?? null,
    leader_validated_at: sub.leaderValidatedAt?.toISOString() ?? null,
    leader_validated_by: sub.leaderValidatedBy ?? null,
    leader_validated_by_name: sub.leaderValidatedByName ?? null,
    leader_validation_photo_url: sub.leaderValidationPhotoUrl ?? null,
